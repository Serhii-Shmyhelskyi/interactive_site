const butoonSkills = document.querySelector('.skils-b');
const headerSkills = document.querySelector('.skils-header');
const contentSkills = document.querySelector('.skils-content');
